...
<h1 class="text-center"> My Notes </h1>
  <div class="row">
    ...
    <div class="col-6">
        <br><br>
        <?php echo '<form action="Confirm_edit.php?number=' . $index_number. '"class="needs-validation" method="post" novalidate>'     ?> 
            <div class="card">
                                ...
                                echo '<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="content'. $row['number'] .'">
                                    ...
                                    <div class="modal-content text-center">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="Confirm_delete.php?number='. $row['number'] .'" type="button" class="btn btn-primary">ยืนยัน</a> 
                                        </div>
                                    </div>
                                    </div>
                                </div>';
