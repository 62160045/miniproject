        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <?php 
                        echo '<a href="Confirm_edit.php?number=' . $index_number . '" class="fas fa-save col-md-3 text-center" style="font-size: 2.5em; "></a>'
                    ?> 
                </div>
            </div>
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            <div class="card-footer bg-transparent border-success text-center">
                                <a href="delete.php?number=' . $row['number'] . '" class="fas fa-trash-alt col-md-3 text-center" style="font-size: 2.5em;color: red; "></a>
                            </div>   ';
                        }
                        } else {
                        echo "0 results";
  ...
  <div class="modal-dialog">
    <div class="modal-content text-center">
      ...
      <div class="modal-footer">
        ...
        <a href="Confirm_delete.php?number=<?=$index_number?>" type="button" class="btn btn-primary">ยืนยัน</a> 
      </div>
    </div>
  </div>
</div>
